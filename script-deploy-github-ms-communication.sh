#!/bin/bash
# =============================================================================
# 🚀 MINI MANUAL DE USO — script-deploy-github-ms-communication.sh (ms-communication)
# =============================================================================
# Este script automatiza o ciclo completo de desenvolvimento, build e deploy
# do serviço ms-communication.
#
...
#      $ ./script-deploy-github-ms-communication.sh
#      -> Envia para a branch ativa (ex: develop) e gera as tags:
#         ghcr.io/keepguard/ms-communication:develop-<sha>
#         ghcr.io/keepguard/ms-communication:develop-latest
#
#   2. Commit, push, build e deploy imediato no Docker Compose local:
#      $ ./script-deploy-github-ms-communication.sh up
...
#      $ ./script-deploy-github-ms-communication.sh merge main
...
#      $ ./script-deploy-github-ms-communication.sh merge main up
#
