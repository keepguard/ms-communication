...
# Build Maven, Push (Commit SHA + latest) e Deploy Local do ms-communication (Spring Boot)
#
# Uso:
#   ./script-deploy-github-ms-communication.sh up       # Commit, Push GHCR + Sobe no Docker Local
#   ./script-deploy-github-ms-communication.sh          # Commit, Push GHCR (sem subir local)
# =============================================================================
